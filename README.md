...
<br>1)Download the Non-Python folder where you will find 'Sprite-Extracter On-The-Go.zip', then just run it simply, it will work same as the python version. Please dont change the default folder.
<br>User Interface:
